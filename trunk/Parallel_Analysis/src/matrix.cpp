...
void rotate_2_vector(double * vector_1,double * vector_2,double * vector_result)
{
	...
	//
	ga=-gamma/2;
	rotate_matrix_1[0][0]= cos(ga) + (1-cos(ga))*b0_vector[0]*b0_vector[0];
	rotate_matrix_1[0][1]= (1-cos(ga))*b0_vector[0]*b0_vector[1] - b0_vector[2]*sin(ga);
	rotate_matrix_1[0][2]= (1-cos(ga))*b0_vector[0]*b0_vector[2] + b0_vector[1]*sin(ga);
	rotate_matrix_1[1][0]= (1-cos(ga))*b0_vector[0]*b0_vector[1] + b0_vector[2]*sin(ga); 
	rotate_matrix_1[1][1]=cos(ga) + (1-cos(ga))*b0_vector[1]*b0_vector[1];
	rotate_matrix_1[1][2]=(1-cos(ga))*b0_vector[1]*b0_vector[2] - b0_vector[0]*sin(ga);
	rotate_matrix_1[2][0]=(1-cos(ga))*b0_vector[0]*b0_vector[2] - b0_vector[1]*sin(ga);
	rotate_matrix_1[2][1]=(1-cos(ga))*b0_vector[1]*b0_vector[2] + b0_vector[0]*sin(ga);
	rotate_matrix_1[2][2]=cos(ga) + (1-cos(ga))*b0_vector[2]*b0_vector[2];
...
void rotate_n_vector(double ** vectors,int n,double * vector_result)
{
	if(n==4)
	{
		double * vector_1;
		...
		double * vector_1_2;
		double * vector_3_4;
		double * vector_1_2_3_4;
		vector_1=dvector(0,2);
		vector_2=dvector(0,2);
		vector_3=dvector(0,2);
		vector_4=dvector(0,2);
		vector_1_2=dvector(0,2);
		vector_3_4=dvector(0,2);
		vector_1_2_3_4=dvector(0,2);
		for(int i=0;i<3;i++)
		{
			vector_1[i]=vectors[0][i];
		}
		for(int i=0;i<3;i++)
		{
			vector_2[i]=vectors[1][i];
		}
		for(int i=0;i<3;i++)
		{
			vector_3[i]=vectors[2][i];
		}
		for(int i=0;i<3;i++)
		{
			vector_4[i]=vectors[3][i];
		}
		if(dot_product_vector(vector_1,vector_2,3)<0)
		{
			for(int i=0;i<3;i++)
			{
				vector_2[i]=-vectors[1][i];
		...
		if(dot_product_vector(vector_1,vector_3,3)<0)
		{
			for(int i=0;i<3;i++)
			{
				vector_3[i]=vectors[2][i];
		...
		if(dot_product_vector(vector_1,vector_4,3)<0)
		{
			for(int i=0;i<3;i++)
			{
				vector_4[i]=vectors[3][i];
		...
		rotate_2_vector(vector_1,vector_2,vector_1_2);
		rotate_2_vector(vector_3,vector_4,vector_3_4);
		rotate_2_vector(vector_1_2,vector_3_4,vector_1_2_3_4);

		for(int i=0;i<3;i++)
		{
			vector_result[i]=vector_1_2_3_4[i];
		}

		free_dvector(vector_1,0,2);
		free_dvector(vector_2,0,2);
		free_dvector(vector_3,0,2);
		free_dvector(vector_4,0,2);
		free_dvector(vector_1_2,0,2);
		free_dvector(vector_3_4,0,2);
		free_dvector(vector_1_2_3_4,0,2);
