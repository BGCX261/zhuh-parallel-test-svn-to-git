...
目前可以完成的操作和存在的问题：
可以完成的操作：
解决了distribution的MAX和MIN的取值造成的问题！
暂时没有解决的问题：
1.如何处理segment的多样式输入！
version：1.2.0
...
// finished the input data
			...
			for(int i=0;i<6;i++)
			{
				...
				//把二维的数据转化为一维的数据！
						...
						Distribution(vect,size*filesize,output,"rise");
						outfile<<"******************************************************************"<<endl;
						break;
					case 1:
				...
				//把二维的数据转化为一维的数据！
						...
						Distribution(vect,size*filesize,output,"roll");
						outfile<<"******************************************************************"<<endl;
						break;
					case 2:
						...
						Distribution(vect,size*filesize,output,"shift");
						outfile<<"******************************************************************"<<endl;
						break;
					case 3:
						...
						Distribution(vect,size*filesize,output,"slide");
						outfile<<"******************************************************************"<<endl;
						break;
					case 4:
				...
				//把二维的数据转化为一维的数据！
						...
						Distribution(vect,size*filesize,output,"tilt");
						outfile<<"******************************************************************"<<endl;
						break;
					case 5:
				...
				//把二维的数据转化为一维的数据！
						...
						Distribution(vect,size*filesize,output,"twist");
						outfile<<"******************************************************************"<<endl;
						break;
				}
		...
		//		int size=GetBackbonelen(sp);
			...
			for(int i=0;i<14;i++)
			{
				...
				//把二维的数据转化为一维的数据！
						...
						Distribution(vect,size*filesize,output,"alpha");
						outfile<<"******************************************************************"<<endl;
						break;
					case 1:
				...
				//把二维的数据转化为一维的数据！
						...
						Distribution(vect,size*filesize,output,"ampli");
						outfile<<"******************************************************************"<<endl;
						break;
					case 2:
				...
				//把二维的数据转化为一维的数据！
						...
						Distribution(vect,size*filesize,output,"beta");
						outfile<<"******************************************************************"<<endl;
						break;
					case 3:
				...
				//把二维的数据转化为一维的数据！
						...
						Distribution(vect,size*filesize,output,"c1");
						outfile<<"******************************************************************"<<endl;
						break;
					case 4:
				...
				//把二维的数据转化为一维的数据！
						...
						Distribution(vect,size*filesize,output,"c1c2");
						outfile<<"******************************************************************"<<endl;
						break;
					case 5:
				...
				//把二维的数据转化为一维的数据！
						...
						Distribution(vect,size*filesize,output,"c2");
						outfile<<"******************************************************************"<<endl;
						break;
					case 6:
				...
				//把二维的数据转化为一维的数据！
						...
						Distribution(vect,size*filesize,output,"c2c3");
						outfile<<"******************************************************************"<<endl;
						break;
				    case 7:
				...
				//把二维的数据转化为一维的数据！
						...
						Distribution(vect,size*filesize,output,"c3");
						outfile<<"******************************************************************"<<endl;
						break;
					case 8:
				...
				//把二维的数据转化为一维的数据！
						...
						Distribution(vect,size*filesize,output,"chi");
						outfile<<"******************************************************************"<<endl;
						break;
					case 9:
				...
				//把二维的数据转化为一维的数据！
						...
						Distribution(vect,size*filesize,output,"delta");
						outfile<<"******************************************************************"<<endl;
						break;
					case 10:
						outfile<<"the distribution of EPSIL"<<endl;
						outfile<<"******************************************************************"<<endl;
				//
						for(int m=0;m<size;m++)
						{
				...
				//把二维的数据转化为一维的数据！
						...
						Distribution(vect,size*filesize,output,"epsil");
						outfile<<"******************************************************************"<<endl;
						break;
					case 11:
				...
				//把二维的数据转化为一维的数据！
						...
						Distribution(vect,size*filesize,output,"gamma");
						outfile<<"******************************************************************"<<endl;
						break;
					case 12:
				...
				//把二维的数据转化为一维的数据！
						...
						Distribution(vect,size*filesize,output,"phase");
						outfile<<"******************************************************************"<<endl;
						break;
					case 13:
				...
				//把二维的数据转化为一维的数据！
						...
						Distribution(vect,size*filesize,output,"zeta");
						outfile<<"******************************************************************"<<endl;
						break;
					}
...
{
		cout<<endl;
		cout<<"--------------------CurvesTest version 1.2.0--------------------"<<endl;
